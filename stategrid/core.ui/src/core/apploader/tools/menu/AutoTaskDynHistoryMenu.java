...
public class AutoTaskDynHistoryMenu  extends ContributionItem{
	...
	public  AutoTaskDynHistoryMenu(){
		historyDataTpe=HistoryDataType.AUTOTASK;
		showFunctionType=ShowFunctionType.SHOW_MENU_HISTORY;
		iHistoryFieldEvent=CommHistoryDataLoad.autoTaskNavComposite.getIhistoryFieldEvent();
	}
