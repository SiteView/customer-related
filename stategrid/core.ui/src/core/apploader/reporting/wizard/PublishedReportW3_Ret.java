...
public class PublishedReportW3_Ret extends WizardPage {
	 ...
	 */
	public PublishedReportW3_Ret() {
		super("PublishedReportW3_Ret");
		setTitle("\u8981\u68C0\u7D22\u7684\u62A5\u544A");
		setDescription("\u4EE5\u4E0B\u662F\u627E\u5230\u7684\u62A5\u544A\u3002\u9009\u62E9\u8981\u68C0\u7D22\u7684\u62A5\u544A\u3002");
	}
	public PublishedReportW3_Ret(PublishedReportWizard prw) {
		this();
	...
	public void createControl(Composite parent) {
		...
		lblSelectWhetherYou.setText("\u4ECE\u53EF\u7528\u62A5\u544A\u4E2D\u9009\u62E9\u8981\u68C0\u7D22\u7684\u62A5\u544A\u3002");
		
		file_tree = new Tree(container,SWT.BORDER | SWT.CHECK);
		file_tree.setBounds(0, 0, 533, 275);
	...
	public IWizardPage getNextPage() {
		...
		if(canValidate){
			if(!validate()) {
				...
				if(toNextPage){
					if(SaveValues()){
						IWizardPage nextPage = publishReportWizard.getPage("PublishedReportW4_Ret");
						if(nextPage != null){
							if (nextPage.getControl() != null){ 
								nextPage.dispose();
							}
						}
						publishReportWizard.addPage(new PublishedReportW4_Ret(publishReportWizard));
						control = publishReportWizard.getPage("PublishedReportW4_Ret");
						return control;
					}else{
						return this;
					}
